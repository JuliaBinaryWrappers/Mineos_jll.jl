# Autogenerated wrapper script for Mineos_jll for x86_64-w64-mingw32-libgfortran5
export endi, eigcon, green, syndat, minos_bran, cucss2sac, simpledit, eigen2asc
...
const endi_splitpath = ["bin", "endi.exe"]
...
const eigcon_splitpath = ["bin", "eigcon.exe"]
...
const green_splitpath = ["bin", "green.exe"]
...
const syndat_splitpath = ["bin", "syndat.exe"]
...
const minos_bran_splitpath = ["bin", "minos_bran.exe"]
...
const cucss2sac_splitpath = ["bin", "cucss2sac.exe"]
...
const simpledit_splitpath = ["bin", "simpledit.exe"]
...
const eigen2asc_splitpath = ["bin", "eigen2asc.exe"]
...
"""
function __init__()
    global artifact_dir = abspath(artifact"Mineos")

    # Initialize PATH and LIBPATH environment variable listings
    global PATH_list, LIBPATH_list
    # We first need to add to LIBPATH_list the libraries provided by Julia
    append!(LIBPATH_list, [joinpath(Sys.BINDIR, Base.LIBDIR, "julia"), joinpath(Sys.BINDIR, Base.LIBDIR)])
    global endi_path = normpath(joinpath(artifact_dir, endi_splitpath...))

    push!(PATH_list, dirname(endi_path))
    global eigcon_path = normpath(joinpath(artifact_dir, eigcon_splitpath...))

    push!(PATH_list, dirname(eigcon_path))
    global green_path = normpath(joinpath(artifact_dir, green_splitpath...))

    push!(PATH_list, dirname(green_path))
    global syndat_path = normpath(joinpath(artifact_dir, syndat_splitpath...))

    push!(PATH_list, dirname(syndat_path))
    global minos_bran_path = normpath(joinpath(artifact_dir, minos_bran_splitpath...))

    push!(PATH_list, dirname(minos_bran_path))
    global cucss2sac_path = normpath(joinpath(artifact_dir, cucss2sac_splitpath...))

    push!(PATH_list, dirname(cucss2sac_path))
    global simpledit_path = normpath(joinpath(artifact_dir, simpledit_splitpath...))

    push!(PATH_list, dirname(simpledit_path))
    global eigen2asc_path = normpath(joinpath(artifact_dir, eigen2asc_splitpath...))
